...
import { getStatusLabel } from '~/customer/order/order-card';
    ...
    <div className="">
      ...
      <div className="p-2 bg-gray-100 min-h-screen flex flex-col gap-2">
        ...
        <div className="p-4 shadow-md bg-white rounded-lg">
          ...
          <div className="flex items-center mt-1 gap-4 text-sm rounded-lg">
            <p className="font-medium text-gray-800">
              {order.propertyType || 'Tipe properti belum dipilih'}
            </p>
            <p className="text-gray-600">Lantai {order.propertyFloor || '-'}</p>
          </div>

          {/* Note for technician */}
          {order.note && (
            <div className="flex items-center mt-2 gap-2">
              <NotepadTextIcon className=" text-muted-foreground" size={18} />
            ...
            <div className="flex gap-3 ">
              ...
              <div>
                ...
                <p className="text-xs text-gray-800">
                  {order.problems?.join(', ') || 'Tipe layanan belum dipilih'}
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="p-4 shadow-md bg-white rounded-lg">
          <div className="flex">
            <AirVent />
            <h1 className="text-lg font-semibold">Detail Unit AC</h1>
          </div>
                ...
                <div className="flex items-center gap-3">
                  <div>
                    <h1 className="font-medium text-md">
                      {`${acUnit.acTypeName} ${acUnit.acCapacity}`}
                    </h1>
          ...
          <div className="border-t-[1.5px] border-gray-150 mx-auto w-full">
            <div className="mt-2 flex items-center justify-between">
              <h1 className="font-semibold text-md">Total Unit</h1>
        ...
        <div className="bg-white p-4 mb-6 shadow-md rounded-sm">
          <div className="flex justify-between items-center mb-4">
            <div className="font-medium text-gray-700">No. pesanan</div>
            <div className="font-medium">{order.id}</div>
          </div>
          <div className="flex justify-between items-center mb-1">
            <div className="text-sm text-gray-700">Waktu pemesanan</div>
            {/* Created time */}
          ...
          <div className="flex justify-between items-center">
            <div className="text-sm text-gray-700">Tanggal service</div>
            <div className="text-sm text-gray-700">
